...
% frequencies as well.
    if isequal(getHostName, 'smcg_w510')
        load('E:/speechres/signals/leveltest/micRMS_100dBA.mat');      % gives micRMS_100dBA, the wave in level (rms) when the level is 100 dBA. See signals/leveltest/calcMicGain.m
    else
        load('D:/speechres/signals/leveltest/micRMS_100dBA.mat');      % gives micRMS_100dBA, the wave in level (rms) when the level is 100 dBA. See signals/leveltest/calcMicGain.m
    end
