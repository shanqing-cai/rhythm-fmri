...
if bTrigByScanner == 0 % --- For behavioral sessions --- %
    ...
    elseif length(thisphase) > 3 && isequal(thisphase(1 : 3), 'run')
        ...
        msg={sprintf('Run #%d is coming up.', runNum), ...
             ...
             '', ...
             'Press "OK" and then "Play" to continue...'};
    elseif length(thisphase) > 5 && isequal(thisphase(1 : 5), 'inter')
        msg={'To refresh your memory about the corcect volume and', ...
             'speed, let''s do a few practice trials now.', ...
             '', ...
             'Press "OK" and then "Play" to continue...'};
    else
        msg = {''};
