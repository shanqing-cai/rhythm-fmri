...
%% Create data structure for holding IVI (inter-vowel interval) related data
...
% 			end
            ...
            if trialCnt > 1 && (timingDat.trialType(trialCnt - 1) <= 2)
                timingDat.mean_ivi(trialCnt - 1) = hgui1.t_mean_ivi;
                timingDat.cv_ivi(trialCnt - 1) = hgui1.t_cv_ivis;
            end
...
%             data.params.trialType=thisTrial;
            ...
            if (thisTrial==1 || thisTrial==2)
                ...
                cla;
                plot(recMeanSylDurs.nonRhythm,'b.-'); hold on;
                plot(recMeanSylDurs.rhythm,'.-','Color',[0,0.5,0]); 
...
%                 xlabel('Block #');
                ...
                cla;
                plot(20*log10(recMeanPeakRMS.nonRhythm),'b.-'); hold on;
                plot(20*log10(recMeanPeakRMS.rhythm),'.-','Color',[0,0.5,0]);
                set(gca,'XLim',[0,100]);
                xlabel('Block #');
